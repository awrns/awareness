...
class Protocol0Constants:
    ...
    search_task_status_datum_struct =       struct.Struct(
                                                        "!Q B 64s H 3Q B 64s H 3Q"
                                                        )  	                # thresh_idx targ_0 addr0, port0, index0, in_offset0, out_offset0, targ_1, addr1, port1, index1, in_offset1, out_offset1
